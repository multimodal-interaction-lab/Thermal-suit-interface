...
//////////////////////////////////////////////////////////////////////////////
        ...
        public void ResetCanvas()
        {
            ...
            /*            var relativePath = "Assets/background - Copy.PNG";
                        AssetDatabase.ImportAsset(relativePath);
                        drawable_texture = resetobjet.GetComponent<SpriteRenderer>().sprite.texture;*/

            Texture2D originalTexture = resetobjet.GetComponent<SpriteRenderer>().sprite.texture;
            drawable_texture.SetPixels(originalTexture.GetPixels());
            drawable_texture.Apply();
            // Debug.Log(INPUTNAME.options[INPUTNAME.value].text);
            // Debug.Log(currenttrial.GetComponentInChildren<Text>().text);
        }
